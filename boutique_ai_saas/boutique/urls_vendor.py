...
urlpatterns = [
    ...
    path("custom/templates/", views.custom_templates, name="custom_templates"),
    path("custom/templates/save/", views.save_custom_template, name="save_custom_template"),
    ...
    path("tryon/3d/<int:session_id>/", tryon_views.tryon_3d, name="tryon_3d"),
    path("tryon/3d/generate/", tryon_views.generate_3d_api, name="generate_3d_api"),
